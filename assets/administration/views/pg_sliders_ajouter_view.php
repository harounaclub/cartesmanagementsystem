<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
							...
							<div class="row">
								...
								<?php echo form_open_multipart('administration/sliders'); ?> 
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" class="form-control is-invalid state-invalid" name="titre1" placeholder="Titre 1" value="">
													</div>
													<div class="form-group">
														<input type="text" class="form-control is-invalid state-invalid" name="titre2" placeholder="Titre 2" value="" >
													</div>
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														<input type="text" class="form-control is-invalid state-invalid" name="titre3" placeholder="Titre 3" value="" >
													</div>

													<div class="form-group">
														<input type="text" class="form-control is-invalid state-invalid" name="titre4" placeholder="Titre 4" value="" >
													</div>
