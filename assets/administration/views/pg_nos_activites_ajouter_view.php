<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
							...
							<div class="row">
								...
								<?php echo form_open_multipart('administration/nosActivites'); ?> 
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" class="form-control is-invalid state-invalid" name="nom_activite" placeholder="Nom activité" value="">
													</div>
