<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
							...
							<div class="row">
								...
								<?php echo form_open_multipart('administration/nosFormations'); ?> 
										...
										<div class="card-body">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														<input type="text" name="cible" class="form-control is-invalid state-invalid"  placeholder="Cible" value="" >
													</div>

													<div class="form-group">
														<input type="text" name="description_court" class="form-control is-invalid state-invalid" placeholder="Description courte" value="" >
													</div>
