...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "http://cartes.prixkdo.local/assets/wysiwyg/images/";
		
		// Popups Directory
		this.PopupsDir = "http://cartes.prixkdo.local/assets/wysiwyg/popups/";
		
		// CSS Directory File
		this.CSSFile = "http://cartes.prixkdo.local/assets/wysiwyg/styles/wysiwyg.css";		
