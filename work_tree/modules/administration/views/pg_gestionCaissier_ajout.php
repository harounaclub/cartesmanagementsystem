<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
							...
							<?php echo form_open('administration/gestionCaissier_ajout'); ?>
							<div class="row">
								<div class="col-md-12">
									<div class="card shadow">
										<div class="card-header">
											<h2 class="mb-0">Formulaire d'enregistrement de caissier(e)</h2>
										</div>
										<div class="card-body">
												...
												<div class="row">
													...
													<div class="form-group">
														...
														<div class="form-group ">
                                                            ...
                                                            <select class="form-control select2 w-100" name="profils" >
															...
															<?php
																...
																foreach ($list_profils as $info) {
																	...
																	foreach($info["_id"] as $value){
                                                                        ...
                                                                        if($info["code_profils"] == "caisse"){

                                                                        

																	?>

																		<option selected="selected" value="<?php echo $info["code_profils"]; ?>"><?php echo $info["libelle_profils"]; ?> </option>
