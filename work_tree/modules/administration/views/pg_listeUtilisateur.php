<div class="page-header mt-0 shadow p-3">
								...
								<div class="btn-group mb-0">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="<?php echo base_url(); ?>administration/ajoutUtilisateur"><i class="fas fa-plus mr-2"></i>Ajouter un utilisateur</a>
								...
								<div class="col-12">
									<div class="card shadow bg-default">
										<div class="card-header bg-transparent border-0">
											<h2 class="text-white mb-0">Liste des utilisateurs</h2>
										</div>
										<div class="">
														...
														<table class="table card-table table-dark table-vcenter text-nowrap  align-items-center">
															...
															<tbody>
                                                               ...
                                                               <?php
														             ...
														             if(isset($liste_utilisateur)){
                                                                        $compt=0;
															            foreach ($liste_utilisateur as $info) {
																			$compt++;
																...
																<tr>
																	...
																	<td class="text-nowrap">
																		...
																		<a href="<?php echo base_url(); ?>administration/supprimUtilisateur/<?php if(isset($id_mongo)) echo $id_mongo; ?>" class="btn btn-sm btn-primary mt-1 mb-1">Supprimer</a>
																	</td>
																</tr>
