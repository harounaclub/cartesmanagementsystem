<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
							...
							<?php echo form_open('administration/ajoutVille'); ?>
							<div class="row">
								<div class="col-md-12">
									<div class="card shadow">
										<div class="card-header">
											<h2 class="mb-0">Formulaire d'enregistrement d'une ville </h2>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" class="form-control" name="vitrine_ville" placeholder="Entrer le nom de la ville" value="">
														<?php echo form_error('vitrine_ville','<font color="red">','</font>'); ?>
													</div>
													<div class="form-group">
														<textarea class="form-control" name="descriptionVille_vitrine" placeholder="Entrer la description de la ville" rows="5"></textarea>
													    <?php echo form_error('descriptionVille_vitrine','<font color="red">','</font>'); ?>
													</div>
